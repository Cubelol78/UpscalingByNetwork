"""
Onglet Webhooks Discord - Configuration des notifications Discord (Client)
...
class WebhookTab(QWidget):
    """Onglet de configuration des webhooks Discord (Client)"""
    ...
    def SetupUI(self):
        ...
        VarsLabel = QLabel(
            "Variables disponibles: {server_ip}, {server_port}, {batch_id}, "
            "{frame_count}, {duration}, {error}, {reason}, {attempt}, {max_attempts}"
        )
    ...
    def CreateEventsGroup(self) -> QGroupBox:
        ...
        # Catégories d'événements client
        ClientCategories = ["connection", "batches_client", "errors"]

        for CategoryKey in ClientCategories:
    ...
    def LoadConfiguration(self):
        ...
        try:
            ...
            # Activer
            Enabled = ConfigManager.Get("webhook_enabled", False)
            self.EnabledCheckbox.setChecked(Enabled)

            # URL
            Url = ConfigManager.Get("webhook_url", "")
            self.UrlInput.setText(Url)

            # Événements
            Events = ConfigManager.Get("webhook_events", {})
    ...
    def SaveConfiguration(self):
        ...
        try:
            ...
            # Activer
            ConfigManager.Set("webhook_enabled", self.EnabledCheckbox.isChecked())

            # URL
            ConfigManager.Set("webhook_url", self.UrlInput.text())
            ...
            ConfigManager.Set("webhook_events", Events)
